...
<body style="background: lightgray">
    ...
    <div class="container mt-5">
        <div class="row">
            <div class="col-md-12">
                <div>
                    <h3 class="text-center my-4">Website Artikel Laravel</h3>
                    <!-- <h5 class="text-center"><a href="https://mwdcourse.com">www.mwdcourse.com</a></h5> -->
                    <hr>
                </div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="text-center">
                                        <img src="{{ asset('/storage/artikels/'.$artikel->image) }}" class="rounded" style="width: 150px">
                                    </td>
                                    <td>{{ $artikel->title }}</td>
